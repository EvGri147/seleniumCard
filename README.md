[![Build status](https://ci.appveyor.com/api/projects/status/r42fg6uloa3hobim?svg=true)](https://ci.appveyor.com/project/EvGri147/seleniumcard)
...
1. Добавьте в каталог `artifacts` целевой сервис ([`app-order.jar`](artifacts/app-order.jar) — см. раздел «Настройка CI»).
